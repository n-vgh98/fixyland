                    ...
                    <div class="w-100 h-100 border-gray pt-3 mb-5 d-flex flex-column align-items-center padding-bottom">
                        ...
                        <form class="w-75">
                            <div class="mb-3 w-100">
                                <label for="current-pass" class="form-label"> رمز عبور فعلی </label>
                                <input type="password" class="form-control form-bg-color border-0 pt-2 pb-2"
                                    id="current-pass">
                            </div>

                            <div class="mb-3 w-100">
                                <label for="new-pass" class="form-label"> رمز عبور جدید </label>
                                <input type="password" class="form-control form-bg-color border-0 pt-2 pb-2" id="new-pass">
                            </div>

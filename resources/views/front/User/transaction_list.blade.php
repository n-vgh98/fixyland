							...
							<div class="w-100 d-flex flex-column align-items-center">
								<div class="border border-3 border-dark rounded-3 pt-2 pb-2 p-2 p-md-3 mb-4 mt-2 w-75">
									...
									<div class="d-flex flex-column align-items-center mt-3">
										...
										<div class="col-12 col-lg-6 d-flex justify-content-lg-between gap-1 mb-1 flex-column flex-lg-row align-items-center w-75">
											<button id="paying_btn{{$i}}" class="paying_btn btn text-black lightgreen w-50" type="button"> اتمام این کار </button>
											<form class="w-50" method="POST" action="{{ route('user.panel.transactions.cancele.change_status',$doing_archive->id) }}">
											@csrf
											@method('POST')
											<input type="hidden" name="status" value="3">
												<button class="btn btn-outline-danger white text-black w-100" type="submit" > لغو این کار </button>
											</form>
										</div>
									</div>
									...
									<div class="col-12 col-lg-6">
										...
										<form class="mt-4">
											<div class="mb-4">
												...
												<input type="text" class="form-control text-center border border-dark p-2" id="wages0" value="{{$doing_archive->service_cost}} ریال" disabled>
											</div>
											...
											<div class="mb-4">
												...
												<input id="equipment-cost0" type="text" class="form-control text-center border border-dark p-2" value="{{$doing_archive->stuff_cost}} ریال" disabled>
											</div>
											...
											<div class="mb-4">
												...
												<input id="transportation-cost0" type="text" class="form-control text-center border border-dark p-2" value="{{$doing_archive->transport_cost}} ریال" disabled>
											</div>
											...
											<div class="mb-4">
												...
												<input id="total-cost0" type="text" class="form-control text-center border border-dark lightgreen-text fw-bold p-2" value="{{$doing_archive->final_price}} ریال" disabled>
											...
											<div class="mb-4">
												...
												<del class="fw-bold"> {{$doing_archive->final_price}} </del>
												</div>
												<input id="total-cost0" type="text" class="form-control text-center border border-dark lightgreen-text fw-bold p-2" value="{{$doing_archive->total_price}} ریال" disabled>
											...
											<div class="d-flex justify-content-between flex-column flex-md-row mb-md-4 ps-2 pe-2">
												<div>
													...
													<label class="form-check-label pe-1 darkYellow-text fw-bold" for="confirm0">
														تایید می کنم
													</label>
												</div>
												
												<div class="mt-3 mb-3 mt-md-0 mb-md-0">
													<button type="button" class="btn p-0 darkYellow-text_onHover" data-bs-toggle="modal" data-bs-target="#disapprove_modal0" data-bs-whatever="@mdo"> عدم رضایت</button>
													
													<!--modal start-->
													<div class="modal fade" id="disapprove_modal0" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
											...
											<form class="mb-4">
												...
												<div class="d-flex justify-content-center">
													<div class="input-group mb-3 w-100 darkYellow-border rounded-3" dir="ltr">
														<button class="discount_btn btn darkYellow" type="button" id="button-addon0">
															اعمال
														</button>
														<input id="discount-code0" type="text" class="discount_input form-control form-bg-color border-0 text-center" aria-label="text with button addon" aria-describedby="button-addon0" placeholder="کد تخفیف">
													</div>
												</div>
											</form>
						...
						<div id="running_job" class="w-100 d-flex flex-column align-items-center">
							...
							<div class="w-100 d-flex flex-column align-items-center">
								<div class="border border-3 border-dark rounded-3 pt-2 pb-2 p-2 p-md-3 mb-4 mt-2 w-75">
									<div class="container-fluid">
										<div class="row">
											...
											<div class="col-lg-9 col-12 mt-2 mt-sm-0 p-0">
												<p class="m-0 pb-2 ms-lg-3 "> name: {{$doing_archive->technician->name}} </p>
												<p class="m-0 pb-2 ms-lg-3 " > noe: {{$doing_archive->order->service->name}} </p>
												@if($doing_archive->order->order_address_id == null)
												<p class="m-0 pb-2 ms-lg-3 " > address: {{$doing_archive->order->address->state->name}}-{{$doing_archive->order->address->city->name}}-{{$doing_archive->order->address->description}}  </p>
												@else
												<p class="m-0 pb-2 ms-lg-3 " > address: {{$doing_archive->order->order_address->state->name}}-{{$doing_archive->order->order_address->city->name}}-{{$doing_archive->order->order_address->description}}  </p>
												@endif
												<p class="m-0 pb-3 ms-lg-3 " > sharh:  {{$doing_archive->order->description}} </p>
												<form class="ms-lg-3">
												...
												<p class="m-0 mt-3 pb-1 text-center text-lg-end" >{{$doing_archive->created_at->toDateString()}} </p>
									...
									<div class="d-flex flex-column align-items-center mt-3">
										<div class="col-12 col-lg-6 d-flex justify-content-lg-center gap-1 mb-1 flex-column flex-lg-row align-items-center w-75">
											<a href="online-chat.html" class="btn text-decoration-none text-black darkYellow w-50"> <i class="fa-solid fa-comments"></i> chat </a>

											<a href="#" class="btn text-decoration-none text-black darkYellow w-50"> <i class="fa-solid fa-phone-flip"></i> call </a>
										</div>

										<div class="col-12 col-lg-6 d-flex justify-content-lg-center gap-1 mb-1 flex-column flex-lg-row align-items-center w-75">
											<button id="paying_btn{{$i}}" class="paying_btn btn text-black lightgreen w-50">
												etmam kar </button>
											...
											<form class="w-50" method="POST" action="{{ route('user.panel.transactions.cancele.change_status',$doing_archive->id) }}">
												...
												@method('POST')
												<input type="hidden" name="status" value="3">
												<button class="btn btn-outline-danger white text-black w-100" type="submit"> cancel </button>
											</form>
										</div>
									</div>
									...
									<div class="col-12 col-lg-6">
										...
										<form class="mt-4">
											<div class="mb-4">
												...
												<input type="text" class="form-control text-center border border-dark p-2" id="wages0" value="$ {{$doing_archive->service_cost}}" disabled>
											</div>
											...
											<div class="mb-4">
												...
												<input id="equipment-cost0" type="text" class="form-control text-center border border-dark p-2" value="$ {{$doing_archive->stuff_cost}}" disabled>
											</div>
											...
											<div class="mb-4">
												...
												<input id="transportation-cost0" type="text" class="form-control text-center border border-dark p-2" value="$ {{$doing_archive->transport_cost}}" disabled>
											</div>
											@if($doing_archive->total_price == null)
											<div class="mb-4">
												<div class="d-flex justify-content-between">
												...
												<input id="total-cost0" type="text" class="form-control text-center border border-dark lightgreen-text fw-bold p-2" value="$ {{$doing_archive->final_price}}" disabled>
											...
											<div class="mb-4">
												...
												<input id="total-cost0" type="text" class="form-control text-center border border-dark lightgreen-text fw-bold p-2" value="$ {{$doing_archive->total_price}}" disabled>
												
											</div>
											@endif
											<div class="d-flex justify-content-between flex-column flex-md-row mb-md-4 ps-2 pe-2">
												<div>
													<input type="checkbox" required="required" class="form-check-input" id="confirm0">
													<label class="form-check-label ps-1 darkYellow-text fw-bold" for="confirm0">
														Agree
													</label>
												</div>
												
												<div class="mt-3 mb-3 mt-md-0 mb-md-0">
													<button type="button" class="btn p-0 darkYellow-text_onHover" data-bs-toggle="modal" data-bs-target="#disapprove_modal0" data-bs-whatever="@mdo">mablagh mored ghabool nist</button>
											...
											<form class="mb-4">
												<div class="text-end"><label for="discount-code0" class="form-label fw-bold">
													coupan</label></div>
												<div class="d-flex justify-content-center">
													<div class="input-group mb-3 w-100 darkYellow-border rounded-3" dir="ltr">
														<button class="discount_btn btn darkYellow" type="button" id="button-addon0">
														...
														<input id="discount-code0" type="text" class="discount_input form-control form-bg-color border-0 text-center" aria-label="text with button addon" aria-describedby="button-addon0" placeholder="coupan">
													</div>
												</div>
											</form>

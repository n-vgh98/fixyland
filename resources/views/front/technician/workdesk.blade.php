                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <form class="w-100 ms-md-2" method="POST"
                                            action="{{ route('front.technician.panel.workdesk.changeStatus.archive.cancle') }}">
                                            @csrf
                                            <input type="hidden" value="3" name="status">
                                            <button class="w-100 btn btn-outline-dark ms-md-3"
                                                id="job_more_inf_btn{{ $i }}" type="submit"> لغو </button>
                                        </form>
                                    ...
                                    @if ($proccess->isEmpty())
                                        <div class="empty_request w-100 border-gray d-flex justify-content-center">
                                            ...
                                            <div class="position-absolute bottom-0 start-0 d-md-none">
                                                <img class="pic-width-mobile" src="image/undraw_click_here_re_y6uq 1.png"
                                                    alt="user" width="100%">
                                            </div>

                                            <!--undraw vector laptop size-->
                                            <div class="position-absolute bottom-0 start-0 d-none d-md-block">
                                                <img class="pic-width-laptop" src="image/undraw_click_here_re_y6uq 1.png"
                                                    alt="user" width="100%">
                                            </div>
                                            ...
                                            <div class="req-short-dsc d-flex flex-column align-items-center gap-3 mb-3">
                                                ...
                                                @foreach ($proccess as $pro)
                                                    <div class="container-fluid rounded-3 w-75 form-bg-color p-0">
                                                        ...
                                                        <div class="row m-0">
                                                            <div
                                                                class="col-lg-3 col-12 p-0 d-flex justify-content-center mb-2 mb-lg-0">
                                                                <div class="w-100">
                                                                    <img class="rounded-3 mw-100 mh-100"
                                                                        src="image/human3.jpg" alt="specialist"
                                                                        height="auto" width="100%">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div
                                                            class="col-6 d-none d-lg-flex justify-content-center align-items-center">
                                                            <div class="pay-img-size">
                                                                <img class="w-100"
                                                                    src="image/undraw_performance_overview_re_mqrq 1.png"
                                                                    alt="fixing">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="container-fluid rounded-3 w-75 form-bg-color p-0">
                                                @foreach ($canceled_archives as $canceled)
                                                    <div class="row m-0">
                                                        ...
                                                        <div class="col-lg-9 col-12 mt-2 mt-sm-0 p-3">
                                                            <p class="m-0 pb-2 fw-bold"> نام مشتری:
                                                                {{ $canceled->order->user->firstname }}
                                                                {{ $canceled->order->user->lastname }}</p>
                                                            <p class="m-0 pb-2 fw-bold"> نوع:
                                                                {{ $canceled->order->service->name }} </p>
                                                            <p class="m-0 pb-2 fw-bold"> آدرس:
                                                                {{ $canceled->order->address->state->name }}-{{ $canceled->order->address->city->name }}-{{ $canceled->order->address->description }}
                                                            </p>
                                                            <p class="m-0 pb-3 fw-bold"> شرح مشکل:
                                                                {{ $canceled->order->description }} </p>
                                                            <div
                                                                class="w-100 d-flex justify-content-center justify-content-lg-end">
                                                                <p class="m-0 ms-5">
                                                                    {{ $canceled->created_at->toTimeString() }} </p>
                                                                <p class="m-0">
                                                                    {{ $canceled->created_at->toDateString() }} </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                        ...
                                        <div class="empty_request w-100 border-gray d-flex justify-content-center">
                                            ...
                                            <div class="position-absolute bottom-0 end-0 d-md-none">
                                                <img class="pic-width-mobile transform_img"
                                                    src="image/undraw_click_here_re_y6uq 1.png" alt="user" width="100%">
                                            </div>
                                                ...
                                                @foreach ($proccess as $pro)
                                                    <div class="container-fluid rounded-3 w-75 form-bg-color p-0">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div
                                                                class="col-lg-9 col-12 mt-1 mt-sm-0 p-2 d-flex flex-column">
                                                                <p class="m-0 pb-2 fw-bold"> name:
                                                                    {{ $pro->order->user->firstname }}
                                                                    {{ $pro->order->user->lastname }} </p>
                                                                <p class="m-0 pb-2 fw-bold"> noe: {{ $pro->service->name }}
                                                                    rame </p>
                                                                <p class="m-0 pb-2 fw-bold"> addr:
                                                                    {{ $pro->order->address->state->name }}-{{ $pro->order->address->city->name }}-{{ $pro->order->address->description }}
                                                                </p>
                                                                <p class="m-0 pb-3 fw-bold"> sharh:
                                                                    {{ $pro->order->description }} </p>
                                                                <p class="m-0 mb-3 align-self-end">
                                                                    {{ $pro->created_at->toDateString() }}</p>
                                                                <div class="align-self-center mt-auto">
                                                                    <button type="button"
                                                                        class="more_inf_btn{{ $i }}"> moshahede
                                                                    </button>
                                                                </div>
                                                    ...
                                                    <div class="ps-md-3">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-lg-10 col-md-8 col-12 ps-3 order-md-2 order-1">
                                                                ...
                                                                <p class="m-0 pb-2 fw-bold darkgreen-text"> javabe soalat:
                                                                </p>
                                                                @foreach ($pro->order->formresults as $result)
                                                                    <p class="m-0 pb-2">{{ $result->label }}:
                                                                        {{ $result->value }} </p>
                                                                @endforeach

                                                                <p class="m-0 pb-2 fw-bold darkgreen-text"> zaman anjam
                                                                    kar: </p>
                                                                <p class="m-0 pb-3">{{ $pro->order->date }}
                                                                    {{ $pro->order->time }} </p>
                                                            ...
                                                            <div
                                                                ...
                                                                <form class="w-100 ms-md-2" method="POST"
                                                                    ...
                                                                    <input type="hidden" value="{{ auth()->user()->id }}"
                                                                        name="tech_id">
                                                                    <input type="hidden" value="{{ $pro->order->id }}"
                                                                        name="order_id">
                                                                    <input type="hidden" value="2" name="process_status">
                                                                    <button
                                                                        class="w-100 btn btn-outline-dark darkYellow ms-md-3"
                                                                        type="submit"> قبول </button>
                                                                </form>
                                                                <p class="go-back-btn btn btn-outline-dark w-100 mt-3">
                                                                    back </p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-lg-9 col-12 mt-2 mt-sm-0 p-3 d-flex flex-column">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                    class="job_more_inf_btn btn darkYellow w-100 ps-0 pe-0" id="job_more_inf_btn{{ $i }}> moshahede </button>
                        ...
                        <div class="ps-md-3">
                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-10 col-md-8 col-12 ps-3 order-md-2 order-1">
                                    ...
                                    <p class="m-0 pb-2 fw-bold darkgreen-text"> javabe soalat: </p>
                                    @foreach ($pro->order->formresults as $result)
                                        <p class="m-0 pb-2"> {{ $result->label }}: {{ $result->value }}
                                        </p>
                                    @endforeach
                                    <p class="m-0 pb-2 fw-bold darkgreen-text"> zaman anjam kar: </p>
                            ...
                            <div class="w-100 d-flex justify-content-center mb-1 mt-5">
                                <div
                                    ...
                                    <form class="w-100 me-md-2" method="POST"
                                        ...
                                        <input type="hidden" value="2" name="process_status">
                                        <button class="w-100 btn btn-outline-dark darkYellow me-md-3" type="submit">
                                            accept </button>
                                    </form>
                                ...
                                <div class="col-lg-9 col-12 mt-2 mt-sm-0 p-3 d-flex flex-column">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <button type="button" class="job_more_inf_btn btn darkYellow w-100 ps-0 pe-0"
                        ...
                        <form class="mt-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input id="equipment-cost" type="text"
                                    class="form-control text-center border border-dark p-2" placeholder="motabegh faktor">
                            </div>

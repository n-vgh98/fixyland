		...
		<div class="row ms-0 me-0 position-relative">
			...
			<div class="profile-box h-75 col-md-3 d-none d-md-flex flex-column align-items-center ps-0 pe-0 pt-5 pb-5">
					...
					<div class="d-flex mt-2 p-2 ps-3 pe-3 w-100 ">
						...
						<a href="{{ route('front.technician.panel.show') }}" class="text-decoration-none darkYellow-text_onHover text-black-no-hover"> پنل کاربری </a>
					</div>

					<div class="d-flex p-2 ps-3 pe-3 w-100">
						<i class="fa-solid fa-pen-to-square ms-3 mt-1"></i>
						<a href="{{ route('front.technician.panel.edit') }}" class="text-decoration-none darkYellow-text_onHover text-black-no-hover"> ویرایش پروفایل </a>
					</div>
					...
					<div class="d-flex p-2 ps-3 pe-3 w-100">
						...
						<a href="{{ route('front.technician.panel.notification') }}" class="text-decoration-none darkYellow-text_onHover text-black-no-hover"> پیام های فیکسی لند </a>
					</div>
		...
		<div class="row ms-0 me-0 position-relative">
			...
			<div class="profile-box h-75 col-md-3 d-none d-md-flex flex-column align-items-center ps-0 pe-0 pt-5 pb-5">
					...
					<div class="d-flex mt-2 p-2 ps-3 pe-3 w-100">
						...
						<a href="{{ route('front.technician.panel.show') }}" class="text-decoration-none darkYellow-text_onHover text-black-no-hover"> profile </a>
					</div>
					
					<div class="d-flex p-2 ps-3 pe-3 w-100">
						<i class="fa-solid fa-pen-to-square me-3 mt-1"></i>
						<a href="{{ route('front.technician.panel.edit') }}" class="text-decoration-none darkYellow-text_onHover text-black-no-hover"> edit profile </a>
					</div>
					...
					<div class="d-flex p-2 ps-3 pe-3 w-100">
						...
						<a href="{{ route('front.technician.panel.notification') }}" class="text-decoration-none darkYellow-text_onHover text-black-no-hover"> fixy land msgs </a>
					</div>

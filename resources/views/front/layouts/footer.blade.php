...
$articles = App\Models\Lang::where([['name', $lang], ['langable_type', 'App\Models\Article']])
    ->orderBy('created_at', 'DESC')
    ->get()
    ->take(3);
@endphp

@if (app()->getLocale() == 'fa' || (app()->getLocale() == 'ar' && $info != null))
                    ...
                    <ul class="footer-list d-lg-none d-none">
                        @foreach ($articles as $article)
                            ...
                            @if ($last_article->status == 1)
                                <li class="footer-list-item">
                                    <a href="{{ route('front.article.show', [$last_article->id, $last_article->slug]) }}"
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col col-12 col-md-6 order-md-1 text-center text-md-start social-media-footer">
                    <a href="{{ $info->facebook_link }}"><i
                            class="fa-brands fa-facebook-square  ms-2 me-2 white-text"></i></a>
                    <a href="{{ $info->linkedin_link }}"><i
                            class="fa-brands fa-linkedin  ms-2 me-2 white-text"></i></a>
                    <a href="{{ $info->email_link }}"><i class="fa-solid fa-envelope  ms-2 me-2 white-text"></i></a>
                    <a href="{{ $info->instagram_link }}"><i
                            class="fa-brands fa-instagram  ms-2 me-2 white-text"></i></a>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col col-lg-2 col-12 mb-3 p-2">
                        ...
                        <ul class="footer-list d-lg-none d-none">
                            @foreach ($footerlinks as $footerlink)
                                ...
                                @endphp
                                <li class="footer-list-item">
                                    <a href="{{ $link->url }}" class="footer-list-item-link"> {{ $link->name }}
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                    ...
                    <div class="col col-lg-4 col-12 text-center p-0 ">
                        ...
                        <img class="d-inline-block ms-3" src="image/logo.png" alt="fixyland-logo" width="100"
                            height="150">
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col col-12 col-md-6 order-md-1 text-center text-md-end social-media-footer">
                        ...
                        <a href="{{ $info->linkedin_link }}"><i
                                class="fa-brands fa-linkedin  ms-2 me-2 white-text"></i></a>
                        <a href="{{ $info->email_link }}"><i
                                class="fa-solid fa-envelope  ms-2 me-2 white-text"></i></a>
                        <a href="{{ $info->instagram_link }}"><i
                                class="fa-brands fa-instagram  ms-2 me-2 white-text"></i></a>
                    </div>
                </div>
